...
Bionode.prototype.transcribe = function(sequence) {
...
Bionode.prototype.findNonCanonicalSplices = function(sequence, exonsRanges) {
  ...
  function checkNonCanonicalIntron(exonRange, i) {
    ...
    if (intronStartBases !== 'gu' || intronStopBases !== 'ag')
      nonCanonicalIntronsRanges.push(intronRange)
  }
  return nonCanonicalIntronsRanges
}
